# Code of conduct for `ASHE_table_formatting`

Contributors to this repository hosted by `LMHD` are expected to follow the
...
- "Project", we mean this `ASHE_table_formatting` GitHub repository;
- "Maintainer", we mean the `LMHD` organisation owners; and
- "Leadership", we mean both `LMHD` organisation owners, line managers, and other
...
[sam.beale@ons.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:sam.beale@ons.gov.uk
