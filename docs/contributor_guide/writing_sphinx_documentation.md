...
Let us say that `ASHE_table_formatting/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a ReST file, and add the following line to reference the `ASHE_table_formatting` module:

```rest
.. currentmodule:: ASHE_table_formatting
```
...
Let us say that `ASHE_table_formatting/__init__.py` has functions called `hello` and `world` imported
into it, and both have docstrings. To automatically generate docstring documentation,
create a Markdown file, and add the following line to reference the `ASHE_table_formatting` module:
